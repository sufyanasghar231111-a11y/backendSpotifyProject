...
const Left = () => {
    ...
    return (
        <div className={`w-[30%] max-sm:w-[60%] overflow-hidden max-sm:fixed z-50 ${hide ? "max-sm:-translate-x-full max-sm:opacity-0" : "translate-x-0 max-sm:opacity-100"} transition-transform duration-500 ease-out  h-[76vh]  rounded-lg bg-[#282828] flex flex-col `}>
            <HeaderLike />
