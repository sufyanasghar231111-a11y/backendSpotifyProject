        ...
        <div>
            {
                hideSearch && (
                    <>
                        ...
                        <div className={`w-70 max-[500px]:w-48 md:w-80 lg:w-100 max-h-90 md:left-37 left-37  absolute lg:left-42 max-sm:left-22 max-sm:top-10  top-15 overflow-y-auto overflow-x-hidden  z-151 bg-[#2A2A2A] rounded-lg`}>
