...
function SearchBar() {
    ...
    let { searchMusic, music, Issearch, searchinput, loader, searchAlbum } = useContext(authHome)
                                        ...
                                        <>
                                            {
                                                searchinput.trim().length > 1 && (
                                                    showsearch?.map((elem) => {
                                                        ...
                                                        return <div onClick={() => {
                                                            navigate(`/searchmusic/${elem.title}`)
                                                            setHideSearch(false)
                                                        }} className='mx-2 cursor-pointer hover:bg-[#404040] rounded-lg py-2  gap-6 px-3  flex items-center'>
