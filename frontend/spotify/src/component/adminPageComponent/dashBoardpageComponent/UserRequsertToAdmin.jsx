            ...
            >
              <div className="flex items-center gap-3">
                <div className='w-8 h-8 relative rounded-full overflow-hidden'>
                  <div className=' absolute z-9 w-full h-full bg-green-600 text-black flex items-center justify-center text-sm font-semibold'>
                    {extractName}
                  </div>
                  {
                    req.user.pfp && (
              ...
              <div className="flex items-center gap-2">
                <button className="text-xs font-medium text-white bg-green-600 hover:bg-green-700 transition-colors px-4 py-1.5 rounded-md">
                  Approve
                </button>
                <button className="text-xs font-medium text-red-400 bg-red-500/10 hover:bg-red-500/20 transition-colors px-4 py-1.5 rounded-md">
                  Reject
                </button>
              </div>
            </div>
