...
const LikeSong = () => {
  let { fav, playing, playRef, audioRef, setPlaying, deletemusic, loaderTime, handleTime, duration, currentTime } = useContext(authHome)
      ...
      item.favorite?.map((music, index) => (
        ...
        >
          ...
          <div className='flex items-center gap-4'>
            ...
            {/* Search/Input Component - Replace with your Input */}
            <Input key={music._id} music={music} />
