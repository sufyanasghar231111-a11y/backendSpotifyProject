            ...
            {/* Overlay */}
            {
                albumCreateModal && (
                    <>
                        ...
                        {/* Modal */}
                        <div className="fixed z-[300] top-1/2 left-1/2 w-[90%] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-xl bg-[#181818] p-6 shadow-2xl">
                            ...
                            <div className="mt-6">
                                ...
                                <input
                                    ...
                                    disabled={albumButtonLoader}
                                    className="w-full rounded-md border border-zinc-700 bg-[#282828] px-4 py-3 text-white placeholder:text-zinc-500 outline-none transition focus:border-green-500"
                                />
                            </div>
                            ...
                            <div className="mt-8 flex justify-end gap-3">
                                <button
                                    ...
                                    disabled={albumButtonLoader}
                                    className="rounded-full px-5 py-2 font-medium text-white transition hover:bg-zinc-700 disabled:opacity-50"
                                >
                                    Cancel
                                </button>
                                ...
                                <button
                                    ...
                                    className="rounded-full bg-green-500 px-6 py-2 font-semibold text-black transition hover:bg-green-400 disabled:cursor-not-allowed disabled:opacity-50"
                                >
