...
const MusicEditModal = () => {
  const { musicEditPopup, setMusicEditPopup, setTitle, setThumbNail, title , musicPreview, setMusicPreview, updateMusic} = useContext(musicContext)
            ...
            <div className='w-125  bg-[#282828] rounded-lg  absolute top-1/2 left-1/2 z-201 -translate-x-1/2 -translate-y-1/2'>
              ...
              <div className='flex items-center justify-between  px-4  pt-10 py-4'>
                <div className='  w-45 group rounded-full  flex items-center justify-center flex-col h-45  overflow-hidden relative pt-4'>
                  ...
                  <h1 className='bottom-7 hidden cursor-pointer group-hover:block hover:border-b  font-semibold text-[17px] absolute z-60'>Remove photo</h1>
                </div>
