        ...
        hideplay && (
          <>
            ...
            <div className='flex top-1/2 left-1/2 -translate-x-1/2  -translate-y-1/2 items-center justify-center  absolute z-162'>
              <div className=' w-70  rounded-lg bg-[#282828] flex items-center text-center  pt-5 px-4 flex-col'>
                ...
                <div className='py-3  flex w-full  justify-end gap-2 text-sm font-semibold pt-8 '>
                  <button onClick={handleCreatePlaylist} className='border border-[#797777] cursor-pointer rounded-full px-3 py-1 bg-black/50'>Create</button>
                  <button onClick={() => { setHidePlay(false) }} className='border border-[#797777] cursor-pointer rounded-full px-3 py-1 bg-white/10'>Cancel</button>
                </div>
              </div>
            </div>
          </>
